...
Fechar o laptop ou cair a rede envia **SIGHUP** ao shell remoto — jobs podem morrer. Para trabalho interativo longo, use [tmux](../../intermediario/tmux/tmux.md) (ou `screen`) **no servidor**:
