...
Aprofundamento do tópico [O que é um shell?](shell.md). Aqui: canal de texto entre terminal e shell, empilhamento de processos e ambientes Bash no Windows e macOS.
...
**Fish** e **PowerShell** ficam fora da linha Bourne/POSIX — ver tabela em [shell.md](shell.md).
